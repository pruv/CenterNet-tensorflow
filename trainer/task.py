...
import trainer.CenterNet as model
...
def train_and_evaluate(args):
    ...
    exporter = tf.estimator.FinalExporter('census', input_module.SERVING_FUNCTIONS[args.export_format])
    ...
    model.CenterNet(config, trainset_provider)
